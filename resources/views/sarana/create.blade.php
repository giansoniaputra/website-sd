    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="header-title">Tambah Data Sarana</h4>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6">
                        <form action="/sarana/store" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
            ...
            <script>
                $(document).ready(function() {
                    // ID MODAL CROPPER
                    let modal = $("#modal-cropper-sarana")
                    // ID PHOTO YANG ADA DI MODAL
                    let image = document.getElementById('image-sarana');
                    ...
                    //ID BUTTON CROPPER
                    $("#crop-photo-sarana").on("click", function() {
                        modal.modal('hide')
                        ...
                        canvas.toBlob(function(blob) {
                            ...
                            oFReader.onload = function(oFREvent) {
                                var file = dataURLtoFile(oFREvent.target.result, "photo-sarana.png");
