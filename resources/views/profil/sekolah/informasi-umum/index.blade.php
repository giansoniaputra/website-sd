...
<div class="row ms-2 mb-2">
    <div class="col-sm-12"><h3 class="card-title">Data Informasi Umum</h3></div>
</div>
<div class="row">
    <div class="col-12">
        <div class="card">
                        ...
                        @foreach ($informasi as $InformasiUmum)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a title="edit data" href="/informasi-umum/{{ $InformasiUmum->uuid }}/edit" class="btn btn-warning"><i class="ri-edit-2-line"></i></a>
                                    <form action="/informasi-umum/{{ $InformasiUmum->uuid }}" method="POST" style="display:inline">
                                        @csrf
                                        @method('DELETE')
