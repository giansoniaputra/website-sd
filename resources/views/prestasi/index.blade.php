                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a title="edit data" href="/prestasi/{{ $p->uuid }}/edit" class="btn btn-warning"><i class="ri-edit-2-line"></i></a>
                                        <form action="/prestasi/{{ $p->uuid }}" method="POST" style="display:inline">
                                            @csrf
                                            @method('DELETE')
