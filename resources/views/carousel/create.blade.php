...
@section('container')
    ...
    @include('carousel.modal-cropper')
@endsection
...
@section('js_after')
    <script>
        $(document).ready(function() {
            // ID MODAL CROPPER
            let modal = $("#modal-cropper-carousel")
            // ID PHOTO YANG ADA DI MODAL
            let image = document.getElementById('image-carousel');
            ...
            //ID BUTTON CROPPER
            $("#crop-photo-carousel").on("click", function() {
                modal.modal('hide')
                ...
                canvas.toBlob(function(blob) {
                    ...
                    oFReader.onload = function(oFREvent) {
                        var file = dataURLtoFile(oFREvent.target.result, "photo-carousel.png");
