...
@section('content')
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a title="lihat gambar" href="/storage/{{ $kurikulum->photo }}"
                                            class="btn btn-transparent" target="_blank">
                                            <img src="/storage/{{ $kurikulum->photo }}" alt="Foto" width="50">
                                        </a>
                                        {{-- <img src="{{ asset($kurikulum->photo) }}" alt="{{ $kurikulum->nama }}"
                                            style="width: 100px;"> --}}
                                    </td>
                                    <td>
                                        <a href="{{ asset('storage/' . $kurikulum->pdf) }}" target="_blank"
                                            ...
                                            PDF</a>
                                        {{-- <a href="{{ asset($kurikulum->pdf) }}" class="btn btn-primary">Download PDF</a> --}}
                                    </td>
                                </tr>
                                @endforeach
                                </tr>
                                ...
                                @foreach ($kelas as $index => $row)
                                    <li class="nav-item">
                                        <a class="nav-link @if ($index == 0) active @endif"
                                            data-toggle="tab" href="#kelas{{ $row->uuid }}">{{ $row->nama_kelas }}</a>
                                    </li>
                                @endforeach
                            </ul>
    ...
    <div class="modal fade" id="detailModal" tabindex="-1" role="dialog" aria-labelledby="detailModalLabel1"
        aria-hidden="true">
